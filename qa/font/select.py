...
def main(selection_path: str, source_manifest_path: str) -> None:
    ...
    output = ROOT / "assets" / "ayah-markers"; output.mkdir(parents=True, exist_ok=True)
    ...
    (ROOT / "qa" / "font" / "data" / "selection.json").write_text(json.dumps(manifest, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
