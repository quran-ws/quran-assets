...
from qa.font.numbers_geometry import parse_contours  # noqa: E402
...
def main():
    collection = json.load(open(os.path.join(ROOT, "qa", "font", "data", "selection.json")))
    annotations = json.load(open(os.path.join(ROOT, "qa", "font", "data", "annotations.json")))["markers"]
    written = 0
