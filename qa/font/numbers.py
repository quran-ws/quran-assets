...
from qa.font.layer import source_contours
...
def build():
    ...
    coll = json.load(open(os.path.join(ROOT, "qa", "font", "data", "selection.json")))

    exceptions = json.load(open(os.path.join(ROOT, "qa", "font", "data", "number_exceptions.json"))) \
        if os.path.exists(os.path.join(ROOT, "qa", "font", "data", "number_exceptions.json")) else {}
    ...
    placement_path = os.path.join(ROOT, "qa", "font", "data", "number_placement.json")
    ...
    with open(os.path.join(ROOT, "qa", "font", "data", "selection.json"), "w") as fh:
